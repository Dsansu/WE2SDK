...
static HX_CIS_SensorSetting_t OV5647_ae_off[] = {
		{HX_CIS_I2C_Action_W, 0x3503, 0x07},
};

static HX_CIS_SensorSetting_t OV5647_awb_off[] = {
		{HX_CIS_I2C_Action_W, 0x5001, 0x00},
};
 ...
 * CIS Init
 * 
 * \param[in] sensor_init Init sensor default registers or not.
 * \return	error id.
 */
...
void cisdp_sensor_stop()
{
	...
	// Disable AE/AWB
	hx_drv_cis_setRegTable(OV5647_ae_off, HX_CIS_SIZE_N(OV5647_ae_off, HX_CIS_SensorSetting_t));
	//hx_drv_cis_setRegTable(OV5647_awb_off, HX_CIS_SIZE_N(OV5647_awb_off, HX_CIS_SensorSetting_t));
