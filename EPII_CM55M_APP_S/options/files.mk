...
CSRCS_DIR		= $(OS_CSRCDIR) $(OS_HAL_CSRCDIR) $(DEVICE_CSRC_DIR) $(BOARD_CSRC_DIR) $(DRIVERS_CSRCDIR) $(EXTERNAL_CSRCDIR)\
				...
				$(INTEGRATE_CSRCDIR) $(HWACCAUTOTEST_CSRCDIR) $(SCENARIO_APP_CSRCDIR) $(APPL_CSRC_DIR) $(TFM_CSRC_DIR) $(INTERFACE_CSRC_DIR) $(CMSIS_DRIVERS_CSRC_DIR)
CXXSRCS_DIR		= $(OS_CXXSRCDIR) $(OS_HAL_CXXSRCDIR) $(DEVICE_CXXSRC_DIR) $(BOARD_CXXSRC_DIR) $(DRIVERS_CXXSRC_DIR) $(EXTERNAL_CXXSRC_DIR)\
				...
				$(INTEGRATE_CXXSRCDIR) $(HWACCAUTOTEST_CXXSRCDIR) $(SCENARIO_APP_CXXSRCDIR) $(APPL_CXXSRC_DIR) $(TFM_CXXSRCS_DIR) $(INTERFACE_CXXSRC_DIR) $(CMSIS_DRIVERS_CXXSRC_DIR)
CCSRCS_DIR		= $(OS_CCSRCDIR) $(OS_HAL_CCSRCDIR) $(DEVICE_CCSRC_DIR) $(BOARD_CCSRCDIR) $(DRIVERS_CCSRC_DIR) $(EXTERNAL_CCSRC_DIR)\
				...
				$(INTEGRATE_CCSRCDIR) $(SCENARIO_APP_CCSRCDIR) $(APPL_CCSRC_DIR) $(TFM_CCSRC_DIR) $(INTERFACE_CCSRC_DIR) $(CMSIS_DRIVERS_CCSRC_DIR)
ASMSRCS_DIR		= $(OS_ASMSRCDIR) $(OS_HAL_ASMSRCDIR) $(DEVICE_ASMSRC_DIR) $(BOARD_ASMSRC_DIR) $(DRIVERS_ASMSRCDIR) $(EXTERNAL_ASMSRCDIR)\
				...
				$(INTEGRATE_ASMSRCDIR) $(HWACCAUTOTEST_ASMSRCDIR) $(SCENARIO_APP_ASMSRCDIR) $(APPL_ASMSRC_DIR) $(TFM_ASMSRC_DIR) $(INTERFACE_ASMSRC_DIR) $(CMSIS_DRIVERS_ASMSRC_DIR)
INCS_DIR		= $(OS_INCDIR) $(OS_HAL_INCDIR) $(BOARD_INCDIR) $(LIB_INCDIR) $(BOARD_INC_DIR) $(DEVICE_INC_DIR) $(DRIVERS_INCDIR) $(EXTERNAL_INCDIR) $(LIB_BSS_DATA_INCDIR) \
				...
				$(SCENARIO_APP_INCDIR) $(APPL_INC_DIR) $(LINKER_INC_DIR) $(TFM_INC_DIR) $(INTERFACE_INC_DIR) $(CMSIS_DRIVERS_INC_DIR)
###############################################################################
##
...
ALL_CCSRCS = $(sort $(BOARD_CCSRCS) $(DEVICE_CCSRCS) $(DRIVERS_CCSRCS) $(EXTERNAL_CCSRCS) $(LIB_CCSRCS) $(MID_CCSRCS) $(OS_CCSRCS) $(OS_HAL_CCSRCS) $(INTEGRATE_CCSRCS) $(SCENARIO_APP_CCSRCS) $(APPL_CCSRCS) $(TRUSTZONE_SEC_CCSRCS) $(NSC_CCSRCS) $(TFM_CCSRCS) $(INTERFACE_CCSRCS) $(CMSIS_DRIVERS_CCSRCS))
ALL_ALLSRCS = $(sort $(ALL_CSRCS) $(ALL_ASMSRCS) $(ALL_CXXSRCS) $(ALL_CCSRCS))

##
# Collect all object files
##
ALL_COBJS = $(sort $(BOARD_COBJS) $(DEVICE_COBJS) $(DRIVERS_COBJS) $(EXTERNAL_COBJS) $(LIB_INFERENCE_ENGINE_COBJS) $(LIB_CV_COBJS) $(LIB_AUDIOALGO_COBJS) $(LIB_COBJS) $(MID_COBJS) $(OS_COBJS) $(OS_HAL_COBJS) $(INTEGRATE_COBJS) $(HWACCAUTOTEST_COBJS) $(SCENARIO_APP_COBJS) $(APPL_COBJS) $(TRUSTZONE_SEC_COBJS) $(TRUSTZONE_CFG_COBJS) $(NSC_COBJS) $(TFM_COBJS) $(INTERFACE_COBJS) $(CMSIS_DRIVERS_COBJS))
...
ALL_CXXOBJS = $(sort $(BOARD_CXXOBJS) $(DEVICE_CXXOBJS) $(DRIVERS_CXXOBJS) $(EXTERNAL_CXXOBJS) $(LIB_INFERENCE_ENGINE_CXXOBJS) $(LIB_CV_CXXOBJS) $(LIB_AUDIOALGO_CXXOBJS) $(LIB_CXXOBJS) $(MID_CXXOBJS) $(OS_CXXOBJS) $(OS_HAL_CXXOBJS) $(INTEGRATE_CXXOBJS) $(HWACCAUTOTEST_CXXOBJS) $(SCENARIO_APP_CXXOBJS) $(APPL_CXXOBJS) $(TRUSTZONE_SEC_CXXOBJS) $(TRUSTZONE_CFG_CCOBJS) $(NSC_CXXOBJS) $(TFM_CXXOBJS) $(INTERFACE_CXXOBJS) $(CMSIS_DRIVERS_CXXOBJS))
ALL_CCOBJS = $(sort $(BOARD_CCOBJS) $(DEVICE_CCOBJS) $(DRIVERS_CCOBJS) $(EXTERNAL_CCOBJS) $(LIB_CCOBJS) $(MID_CCOBJS) $(OS_CCOBJS) $(OS_HAL_CCOBJS) $(INTEGRATE_CCOBJS) $(SCENARIO_APP_CCOBJS) $(APPL_CCOBJS) $(TRUSTZONE_SEC_CCOBJS) $(NSC_CCOBJS) $(TFM_CCOBJS) $(INTERFACE_CCOBJS) $(CMSIS_DRIVERS_CCOBJS))
ALL_ALLOBJS = $(sort $(ALL_COBJS) $(ALL_ASMOBJS) $(ALL_CXXOBJS) $(ALL_CCOBJS))

HMX_BSP_LIBS = $(sort $(DRIVERS_LIB) $(LIB_LIBS) $(EXTERNAL_LIB) $(MID_LIBS) $(TRUSTZONE_CFG_LIB_ARM) $(CMSIS_DRIVERS_LIB))
##############################################################################